...
# File HOC
The `withFile` HOC adds the ability to read a file contents, create a new file and save changes to a file's content.
...
- `withAuthentication` and 'authentication' are only required for creating and updating files.
