  ...
  return (
    <Paper>
      <BlobComponent
        ...
        blobConfig={{
          url:"https://git.door43.org/api/v1/repos/unfoldingWord/en_ta/git/trees/master",
        }}
...
<Props of={withBlob} isToggle title="Props" />
...
<Props of={Tree} isToggle title="Props" />
...
<Props of={TreeObject} isToggle title="Props" />
...
<Props of={BlobObject} isToggle title="Props" />
